...
for white_box in white_box_list:
    ...
    if white_box == 'Decision tree':
        ...
        f.write('------MLC_NN results-----\n')
    for no in range(0, 3):
        propCheck(no_of_params=2, max_samples=1500, model_type='sklearn', model=FairClassifier.func_main(),
                  mul_cex=True, model_with_weight=True,
                  xml_file='dataInput.xml', train_data_available=True, train_ratio=30, no_of_train=1000,
                  train_data_loc='Datasets/Adult.csv', white_box_model=white_box, no_of_class=2, no_of_layers=2,
                  layer_size=10)
...
for model_path in model_path_list_credit:
    ...
    for white_box in white_box_list:
        ...
        for no in range(0, 2):
            propCheck(no_of_params=2, max_samples=1500, model_type='sklearn', model_path=model_path, mul_cex=True,
                      xml_file='dataInput.xml', train_data_available=True, train_ratio=30, no_of_train=1000,
                      train_data_loc='Datasets/GermanCredit.csv', white_box_model='Decision tree')
...
for white_box in white_box_list:
    ...
    for no in range(0, 3):
        propCheck(no_of_params=2, max_samples=1500, model_type='sklearn', model=FairClassifier.func_main(),
                  mul_cex=True, xml_file='dataInput.xml', train_data_available=True, train_ratio=30, no_of_train=1000,
                  model_with_weight=True, train_data_loc='Datasets/GermanCredit.csv', white_box_model=white_box,
                  no_of_class=2, no_of_layers=2, layer_size=10)
